namespace SwissTransport.Core
{
    ...
    public class Transport : ITransport, IDisposable
    {
        ...
        public StationBoardRoot GetStationBoard(string station, string id, string stationDate)
        {
            ...
            var uri = new Uri($"{WebApiHost}stationboard?station={station}&id={id}&datetime={stationDate}");
